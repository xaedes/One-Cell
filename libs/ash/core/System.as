package ash.core {
	...
	public class System {
		...
		public var profilingEnabled:Boolean = true;
		public var profilingTimeTotal:Number = 0;
		public var profilingNumUpdates:int = 0;
		
		public function get profilingTimePerUpdate():Number {
			return profilingNumUpdates == 0 ? 0 : profilingTimeTotal / profilingNumUpdates;
		}
